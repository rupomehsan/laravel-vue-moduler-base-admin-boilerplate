            ...
            <ul class="navbar-nav align-items-center right-nav-link ml-auto">
                ...
                <li class="nav-item dropdown dropdown-lg">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                New Notifications <a href="javascript:void();" class="extra-small-font">Clear
                                    All</a>
                            </li>
                            <li class="list-group-item">
                                <a href="javaScript:void();">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative">
                        <span class="user-profile">
                            <img src="/backend/assets/images/avatars/avatar-13.png" class="img-circle" alt="user avatar">
                        </span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li class="dropdown-divider"></li>
                        <li class="dropdown-item " s @click="logout()" role="button"><i
                                class="zmdi zmdi-power mr-3"></i>Logout</li>
